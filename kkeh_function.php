...
function createOptionNum(int $firstNumber, int $lastNumber, $nameName)
{
    /*
...
function createOptionWor(array $wordList, $defaultWord, $nameName)
{
    /**
...
function createCheckbox(array $wordList, $nameName)
{
    /**
